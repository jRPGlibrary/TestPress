...
const translations = {
    ...
    'my_little_universe_description': {
        ...
        'en': 'A game where Mario Galaxy meets Minecraft, all sprinkled with a heavy dose of intensive farming. Discover our complete review of this farming and exploration multiplayer game.'
    },
    'my_little_universe_intro_text': {
        ...
        'en': 'Welcome to this review of <strong>My Little Universe</strong>, the game where Mario Galaxy meets Minecraft, all sprinkled with a heavy dose of intensive farming. Tested as a duo with my wife (team love power), the game gave us 6 hours of pure enjoyment despite my initial skepticism — yes, it\'s not my usual genre, but love always triumphs!'
    },
    ...
    'my_little_universe_gameplay_text': {
        ...
        'en': 'In My Little Universe, the adventure begins simply: a skin (basic at the start), one character each, and a universe to rebuild. Playable solo up to 4 players, we chose to farm as a couple, and frankly, it changes everything.'
    },
    ...
    'my_little_universe_gameplay_text3': {
        ...
        'en': 'But here, no Peach to save: we\'re here to get materials! Wood, stones, iron, amethysts... everything goes into crafting and improving your weapons, tools, equipment, in short your survival depends on your lumberjack/tinkerer talents.'
    },
    ...
    'my_little_universe_farming_text2': {
        ...
        'en': 'Alone, the experience could quickly become redundant. But as a duo? It\'s pure joy: we share tasks, organize ourselves, and above all, we laugh like kids.'
    },
    ...
    'my_little_universe_rpg_text2': {
        ...
        'en': 'Your character can also be poisoned, burned or suffer other alterations, adding a well-felt RPG touch to the gameplay.'
    },
    'my_little_universe_conclusion_text': {
        ...
        'en': 'My Little Universe is a masterclass in casual/farming multiplayer. Well optimized, ultra pleasant to play, perfect for chill sessions as a couple or with friends.'
    },
    ...
    'whisker_waters_title': {
        'fr': 'Whisker Waters : Une Aventure de Pêche Inattendue',
    ...
    'fishing_concept': {
        'fr': 'La Pêche : Un Concept Bien Pensé',
    ...
    'whisker_waters_pro_1': {
        'fr': 'Mécanismes de pêche amusants et variés',
        'en': 'Fun and varied fishing mechanics'
    },
    'whisker_waters_pro_2': {
        'fr': 'Personnalisation du personnage agréable',
    ...
    'alzara_interview_title': {
        'fr': 'Interview des développeurs de ALZARA: Radiant Echoes - GameCritique',
        'en': 'Interview with the developers of ALZARA: Radiant Echoes - GameCritique'
    },
    'alzara_interview_description': {
        'fr': 'Découvrez notre entretien exclusif avec les développeurs de ALZARA: Radiant Echoes, un RPG innovant qui mêle fantasy et science-fiction.',
    ...
    'alzara_a10': {
        ...
        'en': 'We have an interview with Motoi Sakuraba coming soon, we invite you to wait a little bit 🙂'
    },
    'challenges_learning': {
        'fr': 'Défis et Apprentissage',
    ...
    'alzara_a14': {
        'fr': 'C\'est encore un peu tôt pour en parler !',
        'en': 'It\'s still a bit early to talk about it!'
    },
    'alzara_questions_help': {
        'fr': 'Ces questions permettront aux lecteurs de mieux comprendre les tenants et aboutissants de "ALZARA: Radiant Echoes", de découvrir l\'équipe derrière le jeu, et de saisir l\'essence de ce projet ambitieux et passionné !',
    ...
    'alzara_trailer': {
        'fr': 'En attendant voici le Trailer 👍',
        'en': 'In the meantime, here\'s the Trailer 👍'
    },
    'alzara_thanks': {
        'fr': 'Merci beaucoup !',
    ...
    'alzara_footer_text': {
        'fr': 'Merci d\'avoir lu cette interview. Pour plus d\'informations sur ALZARA: Radiant Echoes, n\'hésitez pas à consulter la <a href="https://www.kickstarter.com/projects/studiocamelia/seed-a-vibrant-tribute-to-jrpg-classics" target="_blank">page Kickstarter du projet</a>.',
    ...
    'partners_page_description': {
        'fr': 'Découvrez les partenaires de GameCritique, des studios et éditeurs de jeux vidéo qui nous font confiance pour tester et présenter leurs jeux.',
    ...
    'about_list_item2': {
        ...
        'en': '🕹️ An independent space: no external influence, just my authentic feeling'
    },
    'about_list_item3': {
        'fr': '📱 Un complément à mes vidéos TikTok : là où je peux aller plus en détail sur mes tests',
        'en': '📱 A complement to my TikTok videos: where I can go into more detail about my reviews'
    },
    'about_list_item4': {
    ...
    'alzara_a2_p1': {
        ...
        'en': 'We are big JRPG fans and Kickstarter allowed us to fulfill our desire to be closer to our community. For a game that has sharing as its theme, we found that it worked well 🙂'
    },
    'alzara_a2_p2': {
